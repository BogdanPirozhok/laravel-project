                ...
                <table bgcolor="#fff" border="0" cellpadding="0" cellspacing="0" style="margin: 0;padding: 24px 24px 24px 24px; width: 100%;">
                    <tr style="margin-bottom: 24px;display: block;">
                        <td style="text-align: center;display: block;">
                            <span style="font-weight: 500;">Отклик на вакансию</span>
                        </td>
                    </tr>
                ...
                <table bgcolor="#fff" border="0" cellpadding="0" cellspacing="0" style="margin: 0;padding: 0 24px; width: 100%;">
                    <tr style="display: block;margin-bottom: 24px;">
                        <td class="td-colum--one">
                            <span style="font-size: 14px;color: #8787AB;font-weight: 500;">Вакансия:</span>
                        </td>
                        <td class="td-colum--two">
                            <a href="{{ url("/work/vacancy/{$inquirer->vacancy_id}") }}" style="font-size: 14px;color: #5864C5;text-decoration: underline;">
                               {{ url("/work/vacancy/{$inquirer->vacancy_id}") }}
                            </a>
                        </td>
                    </tr>
                    ...
                    <tr style="display: block;margin-bottom: 24px;">
                        ...
                        <td class="td-colum--two">
                            <span style="font-size: 14px;">{{ $inquirer -> name }}</span>
                        </td>
                    </tr>
                    ...
                    <tr style="display: block;margin-bottom: 24px;">
                        ...
                        <td class="td-colum--two">
                            <a href="mailto:ivanovsp74@mail.ru" style="font-size: 14px;">{{ $inquirer -> email }}</a>
                        </td>
                    </tr>
                    ...
                    <tr style="display: block;margin-bottom: 24px;">
                        ...
                        <td class="td-colum--two">
                            <a href="tel:70345873433" style="font-size: 14px;">{{ $inquirer -> phone }}</a>
                        </td>
                    </tr>

                    <tr style="display: block;margin-bottom: 24px;">
                        <td class="td-colum--one">
                            <span style="font-size: 14px;color: #8787AB;font-weight: 500;">Сопроводительный текст:</span>
                        </td>
                        <td class="td-colum--two">
                            <span style="font-size: 14px;">{{ $inquirer -> application_text }} </span>
                        </td>
                    </tr>

                    <tr style="display: block;margin-bottom: 24px;">
                        <td class="td-colum--one">
                            <span style="font-size: 14px;color: #8787AB;font-weight: 500;">Резюме:</span>
                        </td>
                        <td class="td-colum--two">
                            <a href="{{ $inquirer -> resume_file_path }}" download style="font-size: 14px;color: #5864C5;text-decoration: underline;"><img src="{{ asset('library/img/clip.png') }}" alt="" style="margin: 0 8px -1px 0;">{{ $inquirer -> resume_file_name }}</a>
                        </td>
                    </tr>
                </table>
            </center>
